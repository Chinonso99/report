...
<html>
    ...
    <body>
        <div class="container">
            ...
            <?php 
            $query = "SELECT date(`TIME_OF_ENTRY`) as date, max(`LOGGEDIN_USERS`) as visits 
            from DASHBOARD
            where year(`TIME_OF_ENTRY`) = '2020' 
            GROUP BY year(`TIME_OF_ENTRY`)
            order by year(`TIME_OF_ENTRY`) asc";
