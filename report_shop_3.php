...
log_activity($conn,'Viewed the 50% discount store.');
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <?php 
            $query = "SELECT cpe.entity_id as product_id,cpe.sku,cpei.value as product_name,csi.qty as qty,cped.value as price,cped2.value as special_price, cpei.value as value 
            ...
            where cped2.value = cped.value/2";
