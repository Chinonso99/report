...
log_activity($conn,'Viewed the signup logs.');
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <?php 
            $query = "select DATE(createdat) as date , COUNT(*) as signups
            from users where year(createdat) = '2020' group by DATE(createdat);";
