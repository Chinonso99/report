...
<html>
    ...
    <body>
        <div class="container">
            ...
            join users u 
            on th.fromUser = u.id
            where `status` = 'Success' AND date(th.createdAt) BETWEEN '2020-01-01' and '2020-03-31' and `isFor` != 'Topup' and u.`userName` not in ('guest','emeka.uche','munaokeynwosu19','obish1','rachelade','yolzzie',
