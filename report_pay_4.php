...
<html>
    ...
    <body>
        <div class="container">
            ...
            <?php 
            $query = "SELECT date(createdAt) as date, status as status, FORMAT(SUM(fromAmount),2) as amount, isFor as isFor, count(*) as count
            from transactionHistoryNew
            where isfor in ('topup','transfer','billPayment') and year(createdAt) = '2020'
            group by date(createdAt), isFor,`status`;
            ";
