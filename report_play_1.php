...
log_activity($conn,'Viewed the Music streams page.'); 
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <?php 
            $query = "SELECT date(createdAt) as date, count(*) as streams
            from `contentViewers` where  year(createdat) = '2020' and uduxid is not null
