...
log_activity($conn,'Viewed the Subscribers page.');
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <?php 
            $query = "SELECT date(createdAt) as date, count(*) as subscribers
            from userSubscription 
            where year(createdat) = '2020' and subscriptionId = 122 
