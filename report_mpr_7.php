...
<html>
    ...
    <body>
        <div class="container">
            ...
            <?php 
            $query = "SELECT status as status, FORMAT(SUM(fromAmount),2) as amount, isFor as isFor, count(*) as count
            from transactionHistoryNew
            where isfor in ('topup','transfer','billPayment') and date(createdAt) BETWEEN '2020-04-01' and '2020-04-17'
            group by isFor,`status`;
            ";
