    ...
    <body>
        <div class="container">
            ...
            <table border='1' style='border-collapse:collapse;'>
                ...
                <th>S/N</th>
                    <th>App Users</th>
                    <th>uwallet balance</th>
                    <th></th>
                    <th></th>
                    <th></th>
                </tr>
            <?php 
            $query = "SELECT count(*) as app_users, sum(walletbalance) as uwallet_balance from users WHERE date(createdAt) < '2020-04-19';";
